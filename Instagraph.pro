...
aptest.commands = bash $$PWD/Instagraph/tests/autopilot/run
aptest.depends  = sub-Instagraph

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Instagraph/tests/unit
